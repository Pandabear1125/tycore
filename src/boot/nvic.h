...
extern irq_handler_t vector_table[NVIC_SUPPORTED_IRQ_NUM + NVIC_SYSTEM_IRQ_NUM] __attribute__((section(".interrupt_vector")));
...
/**
 * @brief Add a custom handler for a specific interrupt.
 * 
...
/**
 * @brief Remove a custom handler for a specific interrupt. Replaces the handler with the default handler.
 * 
