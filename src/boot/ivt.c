...
// RM 9.7.1.1
CDATA SECTION(".ivt") const uint32_t image_vector_table[8] = {
...
// the boot data entry
// RM 9.7.1.2
CDATA SECTION(".boot_data") const uint32_t boot_data[3] = {
...
// RM 9.12
// currently unused
CDATA SECTION(".csf") const uint32_t csf[128] = {0};

// the Serial NOR FlexSPI configuration entry
// RM 9.6.3
// RM 9.6.3.3
CDATA SECTION(".serial_nor_fcfb") const uint32_t serial_nor_configuration[] = {
